...
inline genType mipmap::fetch(glm::vec2 const & TexCoord) const
{
	...
	genType value1 = reinterpret_cast<genType*>(Data.get())[s_below + t_below * width()];
	genType value2 = reinterpret_cast<genType*>(Data.get())[s_above + t_below * width()];
	genType value3 = reinterpret_cast<genType*>(Data.get())[s_above + t_above * width()];
	genType value4 = reinterpret_cast<genType*>(Data.get())[s_below + t_above * width()];
